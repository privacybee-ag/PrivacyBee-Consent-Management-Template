...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Privacybee consent management template",
  "categories": [
    "TAG_MANAGEMENT",
    "UTILITY"
  ],
...
[
  {
    ...
    "help": "Enter your PrivacyBee API Key (e.g., clfwi297w000020pkjuor1iqa ). This API Key connects your consent banner to your PrivacyBee configuration. Find it in your PrivacyBee dashboard",
    "notSetText": "API Key cannot be empty. Please provide your PrivacyBee API Key to continue."
  }
]
